...
@interface MKInfoPanel : UIView {
    ...
    UILabel *__unsafe_unretained _titleLabel;
    UILabel *__unsafe_unretained _detailLabel;
    
    UIImageView *__unsafe_unretained _thumbImage;
    UIImageView *__unsafe_unretained _backgroundGradient;
